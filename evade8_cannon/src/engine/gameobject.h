...
typedef struct GameObject {
	...
	// u8 amount;			// amount of simultaneous shots
	// u8 dir_inc;			// direction increase for each shot
	// u8 fire_rate;		// cannon's fire rate in frames
	// u8 initial_delay;	// cannon's initial delay in frames
